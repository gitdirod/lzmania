...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center border-gray-900 pt-8 sm:pt-0">
                ...
                <img src="../../../public/logo/logo.png" alt="" class="w-10">
                <h1 class="font-bold">Letras </h1>
            </div>
            ...
            <div class="mt-8 bg-white dark:bg-gray-200 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1">
                    ...
                    <div class="p-6 border-gray-100 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-red-600 dark:text-gray-400 text-sm">
                                Laravel's robust library of first-party tools and libraries, such as help you take your
                                projects
